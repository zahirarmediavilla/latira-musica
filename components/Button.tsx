...
const PRIMARY =
  "flex h-12 w-full items-center justify-center gap-2 rounded-full bg-blue text-[15px] font-medium uppercase tracking-[0.06em] text-white transition-colors hover:bg-[#0061b8]";
