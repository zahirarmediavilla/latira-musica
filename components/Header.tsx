    ...
    <header className="sticky top-0 z-30 bg-ink text-white">
      <div className="relative h-[118px]">
        {/* Marca. No es el encabezado de la página (el H1 es sr-only), así que va
            ...
            (top:0). Paths exactos del SVG de diseño, sin recalcular medidas. */}
        <svg
        ...
        >
          ...
          <path d="M105.338 86.6263V56.0263H116.138V86.6263H105.338Z" fill="#FFFDFD" />
          <path d="M105.338 51.9961V0H116.138V51.9961H105.338Z" fill="#FF4203" />
      ...
      <div
        ...
        style={{
          height: resultCount === null ? "0.625rem" : "2.25rem",
